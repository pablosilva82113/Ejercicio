<template>
  <div class="home">
  <h1 class="bienvenida">Bienvenidos pasteleria otra galaxya</h1>
    <img alt="Vue logo" src="../assets/logop.png" class="logo">

    <InfoGeneral>
    </InfoGeneral>
    <ListaPasteles></ListaPasteles>
    <ListaAdornos></ListaAdornos>
  <ListaCovinacionP></ListaCovinacionP>
  <ListaCovinarAd></ListaCovinarAd>
  </div>
   <br> <br>
    <br> <br>
     <br> <br>
...
import ListaPasteles from '../components/ListaPasteles.vue'
import ListaAdornos from '../components/ListaAdornos.vue'
import ListaCovinacionP from '../components/ListaCovinacionP.vue'
import ListaCovinarAd from '../components/ListaCovinarAd.vue'
